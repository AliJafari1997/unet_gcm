...
if __name__ == "__main__":
    ...
    """ Directories """
    create_dir("/content/drive/MyDrive/unet_gcm_files")

    """ Training logfile """
    train_log_path = '/content/drive/MyDrive/unet_gcm_files/train_log.txt'
    if os.path.exists(train_log_path):
        print("Log file exists")
    else:
        train_log = open('/content/drive/MyDrive/unet_gcm_files/train_log.txt', "w")
        train_log.write("\n")
        train_log.close()
    ...
    checkpoint_path = "/content/drive/MyDrive/unet_gcm_files/checkpoint.pth"
